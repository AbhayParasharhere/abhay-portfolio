    ...
    <section id="about" className="max-w-5xl mx-auto px-6 lg:px-12 py-16">
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        ...
        <div className="lg:w-2/3 space-y-6 text-lg text-slate-300 leading-relaxed">
          <FadeIn delay={0.1}>
            {/* Floated Photo */}
            <div className="float-right ml-6 mb-6 w-32 h-32 md:w-40 md:h-40 relative rounded-2xl overflow-hidden border-2 border-teal/30 shadow-[0_0_30px_rgba(32,201,151,0.15)] group hover:border-teal/50 hover:shadow-[0_0_40px_rgba(32,201,151,0.3)] hover:-translate-y-2 transition-all duration-500">
              <div className="absolute inset-0 bg-teal/10 mix-blend-multiply z-10 transition-opacity group-hover:opacity-0"></div>
              <Image 
                src="/denim.png"
                alt="Abhay Parashar"
                fill
        ...
        <div className="lg:w-1/3 w-full flex flex-col gap-8">
          <FadeIn delay={0.2}>
            <div className="relative rounded-2xl border border-slate-700/50 bg-slate-800/40 backdrop-blur-md p-8 overflow-hidden group hover:border-teal/40 transition-all duration-500 shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_10px_40px_rgba(32,201,151,0.15)] hover:-translate-y-1">
              {/* Subtle gradient background effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-teal/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
